#!/usr/bin/env python
"""ClearML step runner for cl_standardization step.

This is a thin wrapper that imports the main step runner and runs the cl_standardization step.
