#!/usr/bin/env python
"""ClearML step runner for gt_annotation step.

This is a thin wrapper that imports the main step runner and runs the gt_annotation step.
gt_annotation uses AnnotationStep with annotator="ground_truth" to load pre-existing
cell type labels instead of running computational annotation methods.
