#!/usr/bin/env python
"""ClearML step runner for universal_training step.

This is a thin wrapper that imports the main step runner and runs the universal_training step.
