#!/usr/bin/env python
"""ClearML step runner for patch_extraction step.

This is a thin wrapper that imports the main step runner and runs the patch_extraction step.
